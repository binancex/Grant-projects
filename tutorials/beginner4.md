## Project Satoshi: Beginner pt.4 tutorial
...
- Write and deploy a token swap contract that automatically exchanges token A to an equal balance of token B for all holders of token A, burning token A after the swap.
